...
public class CustomTextWatcher implements TextWatcher {
    ...
    public void onResult(GooglePlaceEvent googlePlaceEvent) {
        ...
        //Log.d("MedApp.class","Fill The autoCompleteList");
    }
    ...
    public void makeList(List<HashMap<String, String>> result){
        ...
        AutoCompleteAdapter adapter = new AutoCompleteAdapter(atv.context, result, R.layout.autocomplete_list_item, from, to);

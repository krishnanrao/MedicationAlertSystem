...
public class GoogleLogin extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Smart Pill Reminder");
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            loginIntent.putExtra("uName",personName);
            loginIntent.putExtra("uEmail",email);
            loginIntent.putExtra("uPhotoUrl",personPhotoUrl);

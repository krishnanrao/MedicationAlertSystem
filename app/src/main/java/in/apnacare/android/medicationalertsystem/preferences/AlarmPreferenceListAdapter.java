...
import in.apnacare.android.medicationalertsystem.preferences.AlarmPreference.Type;
...
public class AlarmPreferenceListAdapter extends BaseAdapter implements Serializable {
    ...
    public AlarmPreferenceListAdapter(Context context, Alarm alarm) {
        ...
        Log.d("AlarmPrefeceListAdapter","Loading Ringtones");
        ...
        Log.d("Alarr", "Finished Loading " + alarmTones.length + " Ringtones.");
        alarmsCursor.close();
